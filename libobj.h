...
typedef struct _GLMmaterial
{
    ...
    _GLMmaterial()
    {
        ...
        char default_texture[] = "no_texture";
    ...
    void display()
    {
        ...
        cout << "Texture: "         << texture      << endl << endl;
    }
...
GLvoid glmDrawVBO(GLMmodel* model, Texture* pTextures, GLuint program);
bool LoadTextures(GLMmodel* model, Texture* pTextures, const char *path_to_textures);
GLvoid glmDisplayVBOMaterials(GLMmodel* model);
